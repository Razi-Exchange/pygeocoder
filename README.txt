...
This is an update to pygeocoder 1.2.5 to make it compatible with Python 3.10. The package was not on github which is why it was not forked. I downloaded the tar from pypi and uploaded it to github.

==================
pygeocoder 1.2.5 (legacy readme)
==================
Xiao Yu
